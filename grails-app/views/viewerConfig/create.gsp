...
<body>
<a href="#create-viewerConfig" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-viewerConfig" class="content scaffold-create" role="main">
    <div class="title"><span class="title_icon"><g:img dir="images" file="bullet1.gif" alt=""
                                                       title=""/></span><g:message code="default.create.label"
                                                                                   args="[entityName]"/></div>
