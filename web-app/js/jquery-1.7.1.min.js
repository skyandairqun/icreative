...
var count,total,cur_no = 0;
$(".headerSmallDiv img").eq(cur_no).show();
function clickNext(){
    if(cur_no == (total-1)){
        return;
    } else{
        $(".headerSmallDiv img").eq(cur_no).hide();
        cur_no =cur_no+ 1;
        $(".headerSmallDiv img").eq(cur_no).show();
    }
}
...
$(function(){
    ...
    //显示一个dl
    $('.list dl:first').slideDown("fast");

    //给第一个标题加新css
    $('.list h4:first').addClass("open");
    ...
    $('.list h4').click(
        function () {
            ...
            //如果当前标题下的dl不是最后一个（判断的是当前标题下的dl的下一个dl存在），并且打开状态
            else if ($(this).next('dl').next().next("dl").length > 0) {
                //关闭当前标题下的dl
                $(this).next("dl").slideUp("fast");
                //移除当前标题的新css
                $(this).removeClass("open");
                //打开下一个dl
                $(this).next('dl').next().next("dl").slideDown("fast");
                //给下一个标题加新css
                $(this).next('dl').next().addClass("open");
            }
            //如果当前标题下的dl是最后一个，并且打开状态
                ...
                $(this).removeClass("open");
                //显示一个dl
                $('dl:first').slideDown("fast");
                //给第一个标题加新css
                $('h3:first').addClass("open");
            }
        })
    $('.list dt').click(
        function () {
            ...
            if ($(this).next("dd").css("display") == "none") {
                ...
                //打开下一个dd
                $(this).next('dd').next().next("dd").slideDown("fast");
                //给下一个dt加新css
                $(this).next('dd').next().addClass("open2");
            }
        })
})